...
COC_DICE_LANG =
{
	...
	--[[向文本传入的参数：
		...
		若有奖励骰或惩罚骰，则会像这样：1D100=57[奖励骰：2, 8]=27，引用_.BONUS_DICE
	...
	WILSON =
	{
		...
		RA = "我认为{RA_NAME}很值得研究：{EXP}，{RA_RES}"
		RA_RES =
		{
			"大失败——哦不，我的实验引发了爆炸！",
			"失败了——通往真理的道路总是曲折的。",
	...
	WILLOW =
	{
		...
		SC_SUCCESS = "还好成功了，扣除了{EXP_2}点SAN，这些衣服都要烧掉！",
	...
	WOLFGANG =
	{
		...
		RA = "沃尔夫冈用强大的肌肉{RA_NAME}：{EXP}，{RA_RES}",
		RA_RES = 
		{
			"大失败。哦不，沃尔夫冈搞砸了这场演出！",
			"失败，沃尔夫冈的肌肉还不够强大。",
...
COC_DICE_LANG = setmetatable(COC_DICE_LANG, { __index(t, k) return t.DEFAULT end })